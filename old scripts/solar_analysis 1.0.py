...
print('Total Annual Forecast Future battery savings: $'+ str(round(future_battery_savings_total*1.33, 1)))

# future cost + additional energy usage - 200+200+100+100+70+0+0+200+100+100+200+200=1470 (do 0.8 for estimate error)
additional_energy_usage = 1176
additional_savings = additional_energy_usage * (future_per_kwh_charge - future_feed_in_tariff)
print('Total Annual Forecast Future battery savings with additional power usage: $'+ str(round(future_battery_savings_total*1.33 + additional_savings, 1)))